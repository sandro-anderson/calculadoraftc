...
btn_config.addEventListener("click" , function(){
    ...
    btn_config.textContent = "FEITO"
    document.documentElement.style.setProperty('--collor_btn_config', 'rgb(9, 177, 9)')
    }
})

function mudar_btn_config(){
    console.log("XXX")
    btn_config.textContent = "CONFIGURAR"
    document.documentElement.style.setProperty('--collor_btn_config', 'rgb(255, 255, 255)')
}
